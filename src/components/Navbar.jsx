...
export default function Navbar() {
  ...
  const navLinks = [
    { name: "Home", path: "/", icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M3 9l9-7 9 7M4 10v10a1 1 0 001 1h14a1 1 0 001-1V10"/></svg> },
